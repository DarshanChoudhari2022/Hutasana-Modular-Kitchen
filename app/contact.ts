...
const baseMessage =
  "Hello Hutāśana Intelligent Kitchen Designs (INDIA) LLP, I want a modular kitchen quotation.";

export const whatsappMessages = {
  general:
    "Hello Hutāśana Intelligent Kitchen Designs (INDIA) LLP, I am sharing my details for a modular kitchen quotation.",
  default: baseMessage,
